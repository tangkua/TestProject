...
<sql:query dataSource="${webappDataSource}" sql="select * from tbl_book order by count_book desc " var="result6" />
							<div class="container">
		...
		<div class="container" style="width: 100%">
							...
							<div style="margin-top: 20px">
								<label style="font-size: 24px"> <span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> &nbsp;All Popular Book
								</label>&nbsp; <label style="font-size: 16px">หนังสือยอดนิยมทั้งหมด</label>
