...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color: black">
	<div class="container">
		...
		<div class="navbar-header page-scroll">
			...
			<a class="navbar-brand page-scroll" href="home.jsp">Voice and Book Sharing</a>
		</div>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a class="page-scroll dropdown-toggle" data-toggle="dropdown" aria-expanded="true" href="#services"><span class="glyphicon glyphicon-open" aria-hidden="true"></span>Upload</a>
					<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
						<li role="presentation"><a role="menuitem" tabindex="-1" value="Upload" data-toggle="modal" data-target="#popupupload">Upload Audio </a></li>
						<li role="presentation"><a role="menuitem" tabindex="-1" value="Upload" data-toggle="modal" data-target="#popupuploadbook">Upload Book</a></li>
						<li role="presentation"><a role="menuitem" tabindex="-1" value="Upload" data-toggle="modal" data-target="#popupuploadchapter">Upload Chapter</a></li>
					</ul></li>
				<li><a class="page-scroll" href="record.jsp"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>Record</a></li>
...
<div class="modal fade" id="search" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<label class="radio-inline"> <input type="radio"
		name="searchtype" id="Book" value="Book"> Book
	</label>
	<!-- <label class="radio-inline"> <input type="radio"
