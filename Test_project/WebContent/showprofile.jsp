			...
			<div class="col-md-9">
				...
				<div class="container" style="width: 100%">
					<ul class="nav nav-tabs" role="tablist" id="myTab">
						<li role="presentation" class="active"><a href="#book"
							aria-controls="Book" role="tab" data-toggle="tab"><b>Book</b></a></li>

						<li role="presentation"><a href="#audio"
							aria-controls="Audio" role="tab" data-toggle="tab"><b>Audio</b></a></li>
					</ul>
						...
						<div role="tabpanel" class="tab-pane fade in active" id="book"
							...
							<div style="margin-top: 40px">
								<label style="font-size: 24px"> <span
									...
									&nbsp;My Books
								</label>&nbsp; <label style="font-size: 16px"></label> &nbsp <label
									style="font-size: 16px">หนังสือที่อัพโหลด</label>
										...
										<div class="col-md-3"
											...
											<div class="row">
												<div class="col-md-12 container show-pic-home"
													style="width: 100%;">
													<a href="ShowBookProfileServlet?bookid=${row.book_id}"><img
														src="ShowBookSevlet?bookid=${row.book_id}"
														alt="${row.title}" class="img-thumbnail center-block"
													...
													<div
														...
														<div style="text-align: center">
															<span class="glyphicon glyphicon-heart-empty"
																title="favorite"></span><label>${row.count_book}</label>
														</div>
													</div>
											...
											<!--container image-->
											<c:set var="bookid" value="${row.book_id}"></c:set>

											<sql:setDataSource var="webappDataSource"
												driver="com.mysql.jdbc.Driver"
												url="jdbc:mysql://localhost:3306/rvcdb" user="root"
												password="" />
											<sql:query dataSource="${webappDataSource}"
											...
											<div class="row">
												<div class="col-md-12 title break-word" align="center"
													style="height: 60px;">
													<a href="ShowBookProfileServlet?bookid=${row.book_id}"><b>${row.title}</b></a>
											...
											<div class="row">
												<table class="col-md-12" align="center">
													<tbody>
														<tr>
															<td class="col-md-12 by-user"><strong>${row.owner}</strong></td>
														</tr>
														<tr>
							...
							<div style="margin-top: 20px">
								<label style="font-size: 24px"> <span
									class="glyphicon glyphicon-tasks" aria-hidden="true"></span>
									&nbsp;Favorite Book
								</label>&nbsp; <label style="font-size: 16px">หนังสือที่ชื่นชอบ</label>

								<!--pic book content-->
								<div class="row">

									<c:forEach var="row" items="${favvbok.rows}">
										<div class="col-md-3"
											style="border-style: solid; border-width: 5px;">
											<div class="row">
												<div class="col-md-12 container show-pic-home"
													style="width: 100%;">
													<!--image-->
													<a href="ShowBookDetailServlet?bookid=${row.book_id}">
													<img
														src="ShowBookSevlet?bookid=${row.book_id}"
														alt="${row.title}" class="img-thumbnail center-block"
														style="height: 240px; width: 170px; max-width: 170px; max-hight: 240px;"></a>
											...
											<div class="row">
												<div class="col-md-12 title break-word" align="center"
													style="height: 60px;">
													<a href="profile.html"><b>${row.title}</b></a>
												</div>
											</div>
											...
											<div class="row">
												<table class="col-md-12" align="center">
													<tbody>
														<tr>
															<td class="col-md-12 by-user">${row.owner}</td>
														</tr>
														<tr>
															<td class="col-md-12 " style="text-align: right;"><p
																	class="glyphicon glyphicon-time time-home"
						...
						<div role="tabpanel" class="tab-pane fade" id="audio">
							...
							<div style="margin-top: 40px">
								<label style="font-size: 24px"> <span
									class="glyphicon glyphicon-tasks" aria-hidden="true"></span>
									&nbsp;My Audios
								</label>&nbsp; <label style="font-size: 16px"></label>
									...
									<c:forEach var="row" items="${resulta.rows}">
										<div class="col-md-3"
											...
											<div class="row">
												...
												<div class="col-md-12 container show-pic-home"
													style="width: 100%;">
													<a href="SelectAudioServlet?audioid=${row.audio_id}&userid=${user.getId()}"><img
														src="img/audio.jpg"
														alt="${row.title}" class="img-thumbnail center-block"
														style="height: 240px; width: 170px; max-width: 170px; max-hight: 240px;"></a>
													<div
														style="position: absolute; top: 213px; width: 170px; height:25px; border-width: 1px; background-color: #fff; opacity: 0.6;">
														<div style="text-align: center">
															<span class="glyphicon glyphicon-heart-empty" style="margin-top:2px"
													...
													${row.audio_id}
													<form  action="EditAudioServlet" method="post">
													<input type="hidden" name="audioid" value="${row.audio_id}">
													<button class="btn btn-info btn-sm"
											...
											<div class="row">
												<div class="col-md-12 title break-word" align="center"
													style="height:60px;">
													<a href="ShowAudioServlet?audioid=${row.audio_id}"><b>${row.audio_name}</b></a>
													<!--  <form action="DeleteAudioServlet" method="post">
											...
											<div class="row">
												<table class="col-md-12" align="center">
													<tbody>
													<tr>
															<td class="col-md-12 " style="text-align: right;">
																<p class="glyphicon glyphicon-time"
																	style="color: #ecf0f1; font-size: 7px">${row.audio_datetime}</p></td>
														</tr>
														<sql:query dataSource="${webappDataSource}"
